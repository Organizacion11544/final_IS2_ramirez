...
const guardar = async (evento) => {
    ...
    const url = '/final_IS2_ramirez/API/asignaciones/guardar';
    const config = {
        method : 'POST',
        // body: otroNombre
        body
...
const buscar = async () => {
    ...
    const url = `/final_IS2_ramirez/API/asignaciones/buscar?asignacion_id_aplicacion=${asignacion_id_aplicacion}&asignacion_id_programador=${asignacion_id_programador}`;
    const config = {
        method : 'GET'
    }
    ...
    try {
        ...
        if(data.length > 0){
            ...
            data.forEach( asignacion => {
                ...
                td2.innerText = asignacion.asignacion_id_aplicacion
                td3.innerText = asignacion.asignacion_id_programador
...
const colocarDatos = (datos) => {
    formulario.asignacion_id_aplicacion.value = datos.asignacion_id_aplicacion
    formulario.asignacion_id_programador.value = datos.asignacion_id_programador
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/final_IS2_ramirez/API/asignaciones/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (id) => {
    if(await confirmacion('warning','¿Desea eliminar este registro?')){
        ...
        const url = '/final_IS2_ramirez/API/asignaciones/eliminar';
        const config = {
            method : 'POST',
            body
        }
