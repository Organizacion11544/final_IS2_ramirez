...
const guardar = async (evento) => {
    ...
    const url = '/final_IS2_ramirez/API/aplicaciones/guardar';
    const config = {
        method : 'POST',
        // body: otroNombre
        body
...
const buscar = async () => {
    ...
    const url = `/final_IS2_ramirez/API/aplicaciones/buscar?aplicacion_nombre=${aplicacion_nombre}&aplicacion_fecha_inicio=${aplicacion_fecha_inicio}`;
    const config = {
        method : 'GET'
    }
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/final_IS2_ramirez/API/aplicaciones/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (id) => {
    if(await confirmacion('warning','¿Desea eliminar este registro?')){
        ...
        const url = '/final_IS2_ramirez/API/aplicaciones/eliminar';
        const config = {
            method : 'POST',
            body
        }
